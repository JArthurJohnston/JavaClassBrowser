...
public class BaseUIController implements ModelEventListener {
    ...
    /**
     * a method for filling list models. I used a traditional for-loop in leu of
     * a for-each loop to make the method a bit more dynamic. this way, you can
     * pass in a list containing any object you want, and it will work.
     *
     * @param list
     * @param listModel
     */
