...
public class PackageModel extends ProjectModel {
    ...
    protected final LinkedList<ClassModel> classList;
    protected final LinkedList<InterfaceModel> interfaceList;
    ...
    /**
     * Default constructor Should not be called AT ALL!
     */
    ...
    /**
     * Default Project Constructor Constructor used to add a top-level package
     * to a project. It should only be called from a ProjectModel
     *
     * Note:I know overridable calls in the constructor are bad, but in this
     * case it cuts down on repitition. always make sure its called last in the
     * constructor unless absolutely necessary
     *
     * @param parent
     */
    ...
    /**
     * New Sub Package Constructor Used to add a PackageModel to an existing
     * PackageModel Should only be called from a PackageModel
     *
     * @param name String
     */
    ...
    /**
     * used to accept a class that is being moved from a package to this package
     *
